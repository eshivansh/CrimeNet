...
NyayaVault is a **prototype / proof-of-concept** system. It does **not** currently hold any formal compliance certifications. Specifically:
...
NyayaVault provides **technical controls** to support evidence integrity (SHA-256 hashing, append-only audit chains, Merkle anchoring, chain-of-custody tracking). However:
...
- PII (victim/witness/accused identity) is isolated behind Row-Level Security and encrypted fields, but **no system can guarantee absolute data security**.
