...
-- policy and V4 forced it, the application connected as `crimenet` (rolsuper = true)
...
GRANT USAGE ON SCHEMA public TO crimenet_app, crimenet_app;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO crimenet_app, crimenet_app;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO crimenet_app, crimenet_app;

ALTER DEFAULT PRIVILEGES IN SCHEMA public
    GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO crimenet_app, crimenet_app;
ALTER DEFAULT PRIVILEGES IN SCHEMA public
    GRANT USAGE, SELECT ON SEQUENCES TO crimenet_app, crimenet_app;
